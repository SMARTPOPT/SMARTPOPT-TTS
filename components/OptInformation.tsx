...
const OptInformation = () => {
  ...
  return (
    <div className="p-4">
      ...
      {/* Modal Input */}
      {showAddModal && (
        <form onSubmit={handleAddPest} className="fixed inset-0 bg-white p-6 overflow-y-auto z-50">
          ...
          <input className="block w-full mb-4 border p-2" placeholder="URL Gambar (Link Public)" value={newPest.imageUrl} onChange={e => setNewPest({...newPest, imageUrl: e.target.value})} />
